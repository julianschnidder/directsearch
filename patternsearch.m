function [x,fval,exitflag,output] = patternsearch(f,x0,A,b,Aeq,beq,l,u,nonlcon,options)
%x = patternsearch(f,x0)
%x = patternsearch(f,x0,A,b)
%x = patternsearch(f,x0,A,b,Aeq,beq)
%x = patternsearch(f,x0,A,b,Aeq,beq,l,u)
%x = patternsearch(f,x0,A,b,Aeq,beq,l,u,nonlcon)
%x = patternsearch(f,x0,A,b,Aeq,beq,l,u,nonlcon,options)
